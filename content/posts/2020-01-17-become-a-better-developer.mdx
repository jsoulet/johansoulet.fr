...
i18n:
  - locale: fr
    slug: /2020-01-17-become-a-better-developer
---
...
*Okay... you're reading this article in English, so your skill are certainly suffisent enough to understand English ressources.*

Librairies, frameworks, tools almost always have an English version of their documentation and many developers use English to communicate or write comments in their projects, even if it's not their the mother tong. 
...
### 2. Read the documentation of the librairies you use

Popular libraries have a important community in charge of maintening them, and they are also maintain documentation websites. There, you'll find reasons to use/don't use that tool, instructions for setup, use-case, examples...
