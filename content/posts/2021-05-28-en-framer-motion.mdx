...
Lately, I discovered [Motion](https://www.framer.com/motion/), a library developped by Framer, and even if I didn't got the occasion to test all of its options, it already got me out of a tricky situations.
