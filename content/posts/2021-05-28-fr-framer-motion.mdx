---
date: '2021-05-28'
title: "Comment créer une expérience utilisateur vivante grâce à la librairie Motion ?"
...
Depuis quelques années, les micro-animations sont de plus en plus présentes dans les applications web et ne sont plus réservées uniquement aux applications natives. Parce qu'elles permettent d'accompagner l'internaute dans sa navigation ou de donner plus de profondeur au contenu, elles transforment une expérience utilisateur "qui fait le taf" en une expérience " qui fait wow". 
...
Récemment j'ai découvert Motion, développée par Framer, et même si je n'ai pas encore eu l'occasion d'expérimenter cette bibliothèque à son plein potentiel, elle a déjà pu me tirer quelques épines du pied. 
...
On utilise alors useEffect pour alterner entre les états visible et hidden en fonction de .
